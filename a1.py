...
def hours_difference(time_1, time_2):
    ...
    0.0
    """
    x = seconds_difference(time_1,time_2)
    y = 60*60
    return x/y
...
def get_minutes (seconds):
    """ (number) -> number
        ...
        get minutes based in the seconds
        ...
        3
        """
    y = 3600*get_hours(seconds)
    x = seconds_difference(y,seconds)
    return x//60

def get_seconds(seconds):
    """ (number) -> number

            get seconds based in the seconds
...
class Clock(object):
    ...
    def refresh(self, forced=False):
        ...
        self._draw_hand(seconds_angle + 180, 20, fill='pink')
